...
<body>
	...
	<div class="container" style="padding-top: 160px;">
		<form:form class="form-horizontal" action="book" method="POST"
			...
			<div class="row">
				<div class="col-md-6">
					<img src="imgs/coach.jpg" width="400" height="350"
				...
				<div class="row">
					<div class="well col-md-6">
						<div class="row">
							<div class="btn-group">
								<c:forEach var="column" items="${firstRow}">
									<c:choose>
										<c:when test="${column.isBooked()}">
											<label class="btn btn-primary disabled"
												style="background-color: gray; color: orange; width: 50px">
												<form:checkbox path="seatArray"
													value="${column.getSeatId()}" /> ${column.getSeatId()}
											</label>
										</c:when>
										<c:otherwise>
											<label class="btn btn-primary "
												style="background-color: white; color: orange; width: 50px">
												<form:checkbox path="seatArray"
													value="${column.getSeatId()}" /> ${column.getSeatId()}
						...
						<div class="row">
							<div class="btn-group">
								<c:forEach var="column" items="${secondRow}">
									<c:choose>
										<c:when test="${column.isBooked()}">
											<label class="btn btn-primary disabled"
												style="background-color: gray; color: orange; width: 50px">
						...
						<div class="row">
							<div class="btn-group">
								<c:forEach var="column" items="${thirdRow}">
									<c:choose>
										<c:when test="${column.isBooked()}">
											<label class="btn btn-primary disabled"
												style="background-color: gray; color: orange; width: 50px">
						...
						<div class="row">
							<div class="btn-group">
								<c:forEach var="column" items="${fourthRow}">
									<c:choose>
										<c:when test="${column.isBooked()}">
											<label class="btn btn-primary disabled"
												style="background-color: gray; color: orange; width: 50px">
						...
						<div class="row">
							<fieldset>
								<div class="form-group">
									...
									<div class="col-md-4 col-xs-4 ">Seat Available</div>
								</div>
							</fieldset>
						</div>
						<div class="row">
							<fieldset>
								<div class="form-group">
									...
									<div class="col-md-4 col-xs-4 ">Seat Booked</div>
								</div>
							</fieldset>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<div class="alert alert-danger">
								<strong><spring:message code="error.label" />!</strong> ${msg}
							</div>
